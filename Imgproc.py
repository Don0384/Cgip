...
# Convert to grayscale (needed for some operations) gray_img- cv2.cvtColor(img_cv, cv2.COLOR_BGR2GRAY)
...
contrast_stretched_img ((gray_img

print ("Contrast Stretching Done."

# 3. Histogram Equalization (Enhancing Contrast)

hist_eq_img = cv2.equalizeHist(gray_img) print("Histogram Equalization Done.")

#4. Edge Detection (Canny Edge Detector) edges cv2.Canny(gray_img, 100, 200)
